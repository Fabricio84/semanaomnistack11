...
export default function Details() {
  ...
  const message =
    `Olá ${incident.name} APAD, estou entrando em contato pois gostaria de ajudar com o caso da "${incident.title}" com o valor de ` +
  ...
  function sendWhatsapp() {
    Linking.openURL(
      `whatsapp://send?phone=${incident.sendWhatsapp}&text=${message}`
    );
  }
